...
// BADGE FUNCTION
			function d() {
				var _ = e('<a class="last-image"></a>').attr("href", "..."),
					m = e("<img>").attr("src", "...").attr("alt", "").css({
						marginRight: "8px",
						width: "16px"
					}),
					w = e("<h6>").attr("src", "...").attr("alt", "MUHAMMAD AHMAD");
...
Webflow.require('ix2').init({
	"events": {
		"e-25": {
			...
			"target": {
				"id": "0717edbd-96fd-4095-0f71-90b2116b63cd",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-63": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "64002444aa41747eb5d4577e|1e015a52-e6f5-0e13-eae3-70e894cf061b",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-65": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "63f22b1aac84aa82ebce5dcc|e6e0e091-bebb-cb6c-57e0-c82a0ba6f552",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-71": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "64002444aa41747eb5d4577e|8a9f4014-5e4f-475a-46fe-284300086898",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-77": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "63ff43cbe7b16149c1a16399|6919fdc3-9d0e-e920-d1b2-29a5f47f2124",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-79": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "63f22b1aac84aa82ebce5dcc|0ecb6eba-659c-5d5e-e3f3-1e15af13eb41",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-81": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "63ff43cbe7b16149c1a16399|d7e87610-4eb1-83c9-417c-7c1c68562472",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-83": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "6401f0c713fa21385e75dc29|812cb36e-3336-9747-b9de-f08afc733894",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-85": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "6401eb44cb82407798ce7b4e|4225847c-95f6-7b2b-a3d4-9505c6de00e2",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-87": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "6401c5f45499a54b6a7fd9a5|ae2b4c8d-5352-132b-5e66-2848b801faa6",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-89": {
			...
			"target": {
				"id": "63f22b1aac84aa82ebce5dcc|278c5aca-a835-9bca-f387-a89f98d9de23",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-91": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "63ff43cbe7b16149c1a16399|278c5aca-a835-9bca-f387-a89f98d9de23",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
	...
	"actionLists": {
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selector": ".navbar",
							"selectorGuids": ["8fa913f8-d183-c804-d336-4a634446436e"]
						},
						"widthValue": 100,
						"widthUnit": "%",
						"heightUnit": "PX",
					...
					"config": {
						...
						"target": {
							...
							"selector": ".navmenu",
							"selectorGuids": ["af315721-ceb2-f075-326c-f8f48e1eeae7"]
						},
						"value": "block"
					}
				}, {
		...
		"a-7": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"selector": ".lets-work-text",
							"selectorGuids": ["1427448d-8047-7839-bce3-bc730e20d9d9"]
						},
						"zValue": 0,
						"xUnit": "DEG",
						"yUnit": "DEG",
			...
			"createdOn": 1677734557655
		},
		"a-8": {
			"id": "a-8",
			"title": "Let Work Button Hover",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-8-n",
					...
					"config": {
						...
						"target": {
							...
							"selectorGuids": ["899f9ace-2c61-d639-ef60-5f50c6fec9c3"]
						},
						"xValue": 1,
						"yValue": 1,
						"locked": true
			...
			"useFirstGroupAsInitialState": true,
			"createdOn": 1677735121680
		},
		"a-9": {
			"id": "a-9",
			"title": "Let Work Button Hover Out",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-9-n",
					"actionTypeId": "TRANSFORM_SCALE",
		...
		"a-5": {
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selector": ".experience-arrow",
							"selectorGuids": ["69f1778f-a617-04e4-da51-c29f86d8f0e9"]
						},
						"value": 0,
						"unit": ""
					}
			...
			"useFirstGroupAsInitialState": true,
			"createdOn": 1677672090670
		},
		"a-6": {
			"id": "a-6",
			"title": "Experience Block Hover Out",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-6-n",
					"actionTypeId": "STYLE_OPACITY",
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selectorGuids": ["714bd05a-73db-86ec-449e-8759b255b8c7"]
						},
						"xValue": 1,
						"yValue": 1,
						"locked": true
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".work-arrow",
							"selectorGuids": ["6776356f-8f62-9502-116b-9be16a62b0b3"]
						},
						"value": 0,
						"unit": ""
					}
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".work-tag",
							"selectorGuids": ["7832ee0e-9c59-6920-07b5-92a45af84c82"]
						},
						"value": 0,
						"unit": ""
					}
		...
		"a-10": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selectorGuids": ["2193baf7-f695-6097-0bc3-c034faa64a4f"]
						},
						"value": "block"
					}
				}]
				...
				"actionItems": [{
					...
					"config": {
						"delay": 500,
						"easing": [0.977, 0.095, 0.298, 1.001],
						"duration": 500,
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".hero-overlay",
